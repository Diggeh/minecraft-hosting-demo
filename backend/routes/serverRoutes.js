...
// ==========================================
// ROUTE 4.5: View a Single Server
// ==========================================
...
// ==========================================
// ROUTE 8: Send Server Command
// ==========================================
router.post("/:id/command", protect, async (req, res) => {
  try {
    const server = await Server.findById(req.params.id);
    if (!server) return res.status(404).json({ message: "Server not found" });
...
// ==========================================
// ROUTE 10: Update Server Config
// ==========================================
router.patch("/:id/config", protect, async (req, res) => {
  try {
    const server = await Server.findById(req.params.id);
    if (!server) return res.status(404).json({ message: "Server not found" });
...
// ==========================================
// ROUTE 11: File Manager - List Directory
// ==========================================
...
// ==========================================
// ROUTE 10: File Manager - Read File Content
// ==========================================
...
// ==========================================
// ROUTE 11: File Manager - Write File Content
// ==========================================
router.put("/:id/files/content", protect, async (req, res) => {
  try {
    const server = await Server.findById(req.params.id);
    if (!server) return res.status(404).json({ message: "Server not found" });
...
// ==========================================
// ROUTE 12: File Manager - Delete File or Folder
// ==========================================
router.delete("/:id/files", protect, async (req, res) => {
  try {
    const server = await Server.findById(req.params.id);
    if (!server) return res.status(404).json({ message: "Server not found" });
